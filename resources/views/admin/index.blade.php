...
<body class="bg-gray-100 p-6">
    ...
    <nav class="mb-6">
     ...
     <h1 class="text-3xl font-serif mb-4 text-center">Selamat Datang {{Session::get('jabatan')}}</h1>
       <h1 class="text-2xl font-bold mb-4 text-center">Profile</h1> 
        <div class="border border-gray-300 p-5 rounded-lg bg-white text-center">
            ...
            <p class="text-gray-700">Nama: {{$p->nama}}</p>
            <p class="text-gray-700">Jabatan: {{$p->jabatan}}</p>
            <p class="text-gray-700">Email: {{$p->email}}</p>
            <p class="text-gray-700">Alamat: {{$p->alamat}}</p>
            @endforeach
        </div><br><br>
